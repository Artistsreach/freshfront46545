...
const FeatureHighlight = ({
  ...
  return (
    <motion.div
      ...
      className="group"
    >
      <Card className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm border-0 shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden relative">
        <div
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div
              ...
              className="text-center p-6 rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-100 dark:border-blue-800"
            >
        ...
        >
          ...
          <div className="flex justify-center">
            <Button
              ...
              onClick={() => window.open("https://app.freshfront.co", "_blank")}
            >
