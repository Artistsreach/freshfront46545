...
const AIProductDiscovery = () => {
  ...
  return (
    <section className="py-20 px-4 md:px-8 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-blue-900/20 dark:via-indigo-900/20 dark:to-purple-900/20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
                  ...
                  >
                    <ul className="py-1">
                      {filteredNiches.map((niche, index) => (
                        <li
                          key={index}
                          className="px-4 py-2 hover:bg-blue-50 dark:hover:bg-blue-900/30 cursor-pointer text-gray-700 dark:text-gray-200"
                          onClick={() => {
        ...
        {productIdeas.length > 0 && (
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            >
              <Card className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm border-0 shadow-xl h-full">
                <CardHeader>
                  ...
                  <CardContent>
                    ...
                    <div className="flex justify-end">
                      <Button
                        ...
                        onClick={() =>
                          window.open("https://app.freshfront.co", "_blank")
                        }
                      >
