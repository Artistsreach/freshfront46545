          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-2xl border border-white/20 dark:border-gray-700/20">
            <div className="text-center mb-12">
              <div className="flex justify-center mb-6">
                <img
                  src="https://uwbrgokfgelgxeonoqah.supabase.co/storage/v1/object/public/images//Stripelogo.PNG"
                  alt="Stripe Logo"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center gap-3 mb-4">
                <img
                  src="https://uwbrgokfgelgxeonoqah.supabase.co/storage/v1/object/public/images//ffwhite.png"
                  alt="FreshFront Logo"
