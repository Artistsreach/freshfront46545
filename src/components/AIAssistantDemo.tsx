...
const AIAssistantDemo = () => {
  ...
  return (
    <section className="w-full py-16 bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900 px-4 md:px-8 relative overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="absolute inset-0 opacity-20">
          <div className="absolute top-10 left-10 w-40 h-40 rounded-full bg-blue-300 blur-3xl" />
          <div className="absolute bottom-10 right-10 w-60 h-60 rounded-full bg-cyan-300 blur-3xl" />
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 relative z-10">
          <div className="lg:col-span-3">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className="shadow-2xl border-0 h-[500px] flex flex-col bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm">
                <div className="p-4 border-b dark:border-gray-600 flex items-center justify-between bg-slate-50 dark:bg-gray-700">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                        {products.map((product) => (
                          <motion.div
                            ...
                            className="bg-white dark:bg-gray-700 border dark:border-gray-600 rounded-lg overflow-hidden shadow-sm"
                          >
          ...
          <div className="lg:col-span-2">
            ...
            >
              <Card className="shadow-2xl border-0 h-[500px] flex flex-col bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm">
                <div className="p-4 border-b dark:border-gray-600 bg-slate-50 dark:bg-gray-700">
                  <h3 className="font-medium dark:text-white">
                    Assistant Features
                  </h3>
                </div>
                ...
                <CardContent className="p-6 flex flex-col gap-6">
                  ...
                  <div className="mt-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <Badge
                        variant="outline"
                        className="cursor-pointer hover:bg-slate-100 dark:hover:bg-gray-600"
                        onClick={() =>
