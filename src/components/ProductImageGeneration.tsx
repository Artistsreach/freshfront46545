...
const ProductImageGeneration = () => {
  ...
  return (
    <section className="py-20 px-4 md:px-8 bg-gradient-to-br from-purple-50 via-pink-50 to-rose-50 dark:from-purple-900/20 dark:via-pink-900/20 dark:to-rose-900/20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <Card className="h-full bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm border-0 shadow-xl">
              <CardHeader>
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  <Button
                    ...
                    className="w-full border-2 border-dashed border-purple-300 dark:border-purple-600 hover:border-purple-400 p-6 h-auto"
                  >
        ...
        {(generatedImages.length > 0 || isGenerating) && (
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden border border-gray-200/50 dark:border-gray-700/50"
          >
